...
fig1.savefig("./cue_poor_1map.pdf")
fig2.savefig("./cue_rich_1map.pdf")
fig3.savefig("./cue_poor_2map.pdf")
fig4.savefig("./cue_rich_2map.pdf")
fig5.savefig("./cue_poor_shuffle.pdf")
fig6.savefig("./cue_rich_shuffle.pdf")
